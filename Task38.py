...
# Выполняем функции работы с телефонной книгой в зависимости от выбранного пункта меню
...
def delete_user(phone_book):
    user = input('Введите фамилию или имя абонента, которого необходимо удалить: ')
    for elem in phone_book:
